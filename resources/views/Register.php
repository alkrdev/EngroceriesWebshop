        ...
        <article>
            ...
            <form action="<?= url('register') ?>" method="post">
                ...
                <input type="password" name="psw" id="pswregister" placeholder="Kode" required>
                        ...
                        <input type="password" name="psw-repeat" id="pswregisterrepeat" placeholder="Kode igen"
                               required>
                        <span class="validate">Gentag koden præcist</span>

                        <input type="number" maxlength="8" name="phone-number" id="phone-number" placeholder="Telefon"
                               required>
                        ...
                        <input type="number" maxlength="4" name="zip-code" id="zip-code" placeholder="Post Nummer"
                               required>
